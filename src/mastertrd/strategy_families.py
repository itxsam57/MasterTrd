...
class StrategyFamilySpec:
    ...
    max_instruments: int | None = 1
    requires_option_product: bool = False
...
FAMILIES: Mapping[str, StrategyFamilySpec] = {
    ...
    "stat_arb": StrategyFamilySpec("stat_arb", DataLevel.BAR, False, True, min_instruments=2, max_instruments=2),
    "funding_basis": StrategyFamilySpec("funding_basis", DataLevel.BAR, False, True, min_instruments=2, max_instruments=2),
    "delta_neutral": StrategyFamilySpec("delta_neutral", DataLevel.BAR, False, True, min_instruments=2, max_instruments=2),
    "options": StrategyFamilySpec("options", DataLevel.BAR, False, False, requires_option_product=True),
    "portfolio": StrategyFamilySpec("portfolio", DataLevel.BAR, False, True, min_instruments=2, max_instruments=None),
    ...
    "cross_venue_arb": StrategyFamilySpec("cross_venue_arb", DataLevel.TICK, True, True, min_instruments=2, max_instruments=2),
}
